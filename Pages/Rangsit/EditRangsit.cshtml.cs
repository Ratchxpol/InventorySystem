...
using RatchapolCS436_6._1.Pages.Rangsit;
...
namespace InventorySystem.Pages.Rangsit
{
	public class EditRangsitModel : PageModel
	{
		...
		public void OnGet()
		{
			...
			try
			{
				String connectionString = "Server=tcp:ratchapol47.database.windows.net,1433;Initial Catalog=BUMAIL;Persist Security Info=False;User ID=ratchapol;Password=Poom3456;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
		...
		public void OnPost()
		{
			...
			try
			{
				String connectionString = "Server = tcp:inventory345.database.windows.net,1433; Initial Catalog = inventory; Persist Security Info = False; User ID = ratchapol; Password =Poom3456; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30";
				using (SqlConnection connection = new SqlConnection(connectionString))
				{
					connection.Open();
